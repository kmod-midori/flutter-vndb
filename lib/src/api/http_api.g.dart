...
ApiQuery _$ApiQueryFromJson(Map<String, dynamic> json) => ApiQuery(
      filters: json['filters'] as List<dynamic>,
      fields:
          (json['fields'] as List<dynamic>).map((e) => e as String).toList(),
      sort: json['sort'] as String?,
      reverse: json['reverse'] as bool? ?? false,
      results: json['results'] as int? ?? 25,
...
Map<String, dynamic> _$ApiQueryToJson(ApiQuery instance) => <String, dynamic>{
